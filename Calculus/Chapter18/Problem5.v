...
Lemma lemma_18_5_i : ⟦ lim 0 ⟧ (λ x, (exp x - 1 - x - x^2 / 2) / x^2) = 0.
Proof.
  step_lhopital (λ x, (exp x)-1-x) (λ x, 2*x).
  step_lhopital (λ x, (exp x)-1) (λ x : R, 2).
Qed.

Lemma lemma_18_5_ii : ⟦ lim 0 ⟧ (λ x, (exp x - 1 - x - x^2 / 2 - x^3 / 6) / x^3) = 0.
Proof.
...
Lemma lemma_18_5_iii : ⟦ lim 0 ⟧ (λ x, (exp x - 1 - x - x^2 / 2) / x^3) = 1/6.
Proof.
...
Lemma lemma_18_5_iv : ⟦ lim 0 ⟧ (λ x, (ln (1 + x) - x + x^2 / 2) / x^2) = 0.
Proof.
...
Lemma lemma_18_5_v : ⟦ lim 0 ⟧ (λ x, (ln (1 + x) - x + x^2 / 2) / x^3) = 1/3.
Proof.
...
Lemma lemma_18_5_vi : ⟦ lim 0 ⟧ (λ x, (ln (1 + x) - x + x^2 / 2 - x^3 / 3) / x^3) = 0.
Proof.
