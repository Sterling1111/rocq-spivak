...
Lemma lemma_19_10_vii : ∀ c,
  ∫ (λ x, log (x + √ x)) (0, ∞) =
  (λ x, x * log (x + √ x) - x + √ x - log (√ x + 1) + c).
Abort.

Lemma lemma_19_10_viii : ∀ c,
  ∫ (λ x, 1 / (x - x ^^ (3 / 5))) (1, ∞) =
