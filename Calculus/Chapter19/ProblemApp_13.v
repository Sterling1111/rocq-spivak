...
Abort.
(* Finite paint volume does not provide a coating of uniform positive thickness:
   the radius, hence the possible thickness of an interior coating, tends to zero. *)
