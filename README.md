...
- `Calculus/`: Chapter- and problem-indexed files with worked formal proofs from the Calculus text. Currently features 606 stated problems, with **149 problems fully verified** (zero admitted lemmas). The repository contains over 61,000 lines of code across all `.v` files.
